...
namespace ASPMMA.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Products.Include(p => p.Categorys).Include(p => p.Orders).Include(p => p.ShoppingCarts);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Size,Price,StockQuantity,ImageUrl,CategoryId,CreatedAt,ShoppingCartId,OrderId")] Product product)
        {
            ...
            ViewData["ShoppingCartId"] = new SelectList(_context.ShoppingCarts, "Id", "Id", product.ShoppingCartId);
            return View(product);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Size,Price,StockQuantity,ImageUrl,CategoryId,CreatedAt,ShoppingCartId,OrderId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
