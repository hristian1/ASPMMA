...
namespace ASPMMA.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StatusName,Description")] OrderStatus orderStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StatusName,Description")] OrderStatus orderStatus)
        {
